...
///
/// This is a backward-compatible function. For new code, prefer using
/// `DragValue::new()` with the builder pattern.
///
/// # Arguments
...
#[deprecated(
    since = "0.8.0",
    note = "Use DragValue::new() with the builder pattern instead"
)]
pub fn drag_value(
    id: impl Into<String>,
    value: f32,
